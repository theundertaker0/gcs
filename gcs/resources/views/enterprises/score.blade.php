        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $(document).on("click", ".edit", function () {
                    ...
                    var action="{{URL::to('editenterprises',"+ id +")}}";
...
//                var url = "garantiacompletaysegura.com/editenterprises";
...
//                    $('#inputUrlEdit').val(data.url);
//                    $('#inputObservationEdit').val(data.observation);
        ...
        <div id="editEnterpriseModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="formEdit" method="POST" action="" aria-label="{{ __('Enterprises') }}"  enctype="multipart/form-data">
